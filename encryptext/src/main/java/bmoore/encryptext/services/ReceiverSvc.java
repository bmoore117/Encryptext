...
public class ReceiverSvc extends Service {
    ...
    public void onCreate() {
        ...
        HandlerThread worker = new HandlerThread("Receiver Worker");
        worker.start();
        handler = new ReceiverHandler(worker.getLooper(), this);
    ...
    static class ReceiverHandler extends Handler {
        private final WeakReference<ReceiverSvc> reference;

        ReceiverHandler(Looper looper, ReceiverSvc svc) {
            super(looper);
